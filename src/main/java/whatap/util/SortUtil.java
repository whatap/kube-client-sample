...
public class SortUtil {
	...
	public static int[] sort(IntEnumer en, int size) {
		int[] arr = new int[size];
		for (int i = 0; i < size; i++) {
			arr[i] = en.nextInt();
		}
	...
	public static long[] sort(LongEnumer en, int size) {
	...
	public static String[] sort(StringEnumer en, int size) {
	...
	public static String[] sort_string(Enumeration en, int size) {
		String[] arr = new String[size];
		for (int i = 0; i < size; i++) {
