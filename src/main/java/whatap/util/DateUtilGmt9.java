...
public class DateUtilGmt9 {
	...
	public final static DateTimeHelper helper = DateTimeHelper.getDateTimeHelper(TimeZone.getTimeZone("GMT+9"));
	...
	public static String yyyymmdd() {
		return helper.yyyymmdd(DateUtilGmt9.currentTime());
	}

	public static String getLogTime() {
		return helper.logtime(DateUtilGmt9.currentTime());
	}
	...
	public static boolean isToday(long time) {
		return helper.getDateUnit(time) == helper.getDateUnit(DateUtilGmt9.currentTime());
	}
	...
	public static String timestamp() {
		return helper.timestamp(DateUtilGmt9.currentTime());
	}

	public static String timestampFileName() {
		return helper.timestampFileName(DateUtilGmt9.currentTime());
	}
	...
	public static long now() {
		return DateUtilGmt9.currentTime();
	}
	...
	public static void main(String[] args) throws ParseException {
		long time = DateUtilGmt9.currentTime();
		System.out.println(timestamp(time));
		System.out.println(timestamp(getMonth(time, +1)));
		System.out.println(timestamp(getMonth(time, +12)));
		System.out.println(timestamp(getMonth(time, -1200)));
		System.out.println(timestamp(getMonth(time, +1200)));
		System.out.println(timestamp(getDate(time, +3100)));
		System.out.println(timestamp(getDate(time, -3100)));
	}
