...
public class SEED_CTR {
	...
	/**
	@brief byte 占썼열占쏙옙 int 占썼열占쏙옙 占쏙옙환占싼댐옙.
	@param in :占쏙옙환占쏙옙 byte 占쏙옙占쏙옙占쏙옙
	@param nLen : 占쏙옙환占쏙옙 byte 占썼열 占쏙옙占쏙옙
	@return 占쏙옙占쌘뤄옙 占쏙옙占쏙옙 byte 占썼열占쏙옙 int占쏙옙 占쏙옙환占쏙옙 占쏙옙占쏙옙占싶몌옙 占쏙옙환占싼댐옙.
	 */
	...
	/**
	@brief int 占썼열占쏙옙 byte 占썼열占쏙옙 占쏙옙환占싼댐옙.
	@param in :占쏙옙환占쏙옙 int 占쏙옙占쏙옙占쏙옙
	@param nLen : 占쏙옙환占쏙옙 int 占썼열 占쏙옙占쏙옙
	@return 占쏙옙占쌘뤄옙 占쏙옙占쏙옙 int 占썼열占쏙옙 byte占쏙옙 占쏙옙환占쏙옙 占쏙옙占쏙옙占싶몌옙 占쏙옙환占싼댐옙.
	 */
	...
	public static void main(String[] args)
	{
		...
		System.out.print("[ Test SEED CTR reference code ] 占쏙옙占� 1"+"\n");
		System.out.print("\n\n");
		...
		System.out.print("\n\n[ Test SEED reference code CTR] 占쏙옙占� 2"+"\n");
		System.out.print("\n");
